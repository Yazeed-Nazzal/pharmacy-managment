...
<div class="container-fluid">
    <div class="row">
        <div class="col-lg-12 mt-5">
            ...
            <div class="card-body">
                <form class="form-horizontal" action="{{route('alternative_drug.update',$drug->id)}}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="line"></div>
                ...
                <div class="form-group row">
                    ...
                    <a  href="{{route('alternative_drug.index')}}" type="reset" class="btn btn-secondary">Cancel</a>
